...
public class TimeTableView extends LinearLayout {
    ...
    //星期
    protected     String[] weekTitle = {"一", "二", "三", "四", "五", "六", "七"};
    //最大星期数
    ...
    public void addAppListener(OnClickListener listener){
        AppLocker.setOnClickListener(listener);
    }
    /**
     * 加载数据
     *
     ...
     * @param weekNum 周次
     */
    protected     void flushView(Map<Integer, List<Course>> courseMap, long weekNum) {
        //初始化主布局
    ...
    protected     void addWeekTitle(ViewGroup pViewGroup) {
        ...
        //软件锁
        AppLocker = new TextView(mContext);
        AppLocker.setText("AppLocker");
        AppLocker.setLayoutParams(new LayoutParams(dip2px(30), dip2px(30)));
        mTitleLayout.addView(AppLocker);
